# 🏋️ Gym Membership Management System (SQL + Power BI)
...
* Automated subscription tracking (**reduced manual work by 70%+**)
* Monitoring of active, expired, and at-risk memberships
...
This project is based on real-world data.
All shared data and screenshots are **anonymized** to protect user privacy.
